        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-info btn-block add_category">Add</button>
              <p class="alert_msg"></p>
            </div>
            </form>
          </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <!-- Modal -->
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form role="form">
                            ...
                            <!-- /.box-body -->
                          <div class="modal-footer">
                            <button type="button" class="btn btn-info btn-block edit_category" cat-id="{{ $each_category->id }}">Edit</button>
                            <p class="alert_msg"></p>
                          </div>
                          </form>
                        </div>
                    ...
                    <!-- End of Modal -->
                <tr>
                  <td><a href="{{ url('category/'.$each_category->id) }}">{{ $each_category->category_name }}</a></td>
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" category-id="{{ $each_category->id }}" class="btn btn-sm btn-danger rm_category"><i class="fa fa-remove"></i> Delete</a>
                  </td>
                </tr>
                @endforeach
                </tbody>
