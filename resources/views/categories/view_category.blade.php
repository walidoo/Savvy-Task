...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
          <li><a href="{{ url('category/'.$category_name->id) }}">English</a></li>
          <li><a href="{{ url('ar/category/'.$category_name->id) }}">Arabic</a></li>
      </ol>
      <br/>
    </section>
    <!-- Main content -->
    <section class="content">
    	...
    	<div class="row">
            <div class="col-md-7">
                    <img class="img-responsive img-box img-thumbnail" src="{{ asset('public/images/posts/'. $each_category_posts->post_thumbnail) }}" alt="">
            </div>
            <div class="col-md-5">
                <h2>{{ $each_category_posts->post_title }}</h2>
                <p class="lead">
                ...
                <p>{{ implode(' ', array_slice(explode(' ', $each_category_posts->post_desc), 0, 10)) }} (...)</p>
                <a class="btn btn-primary" href="{{ url('/post/'.$each_category_posts->id) }}">Read More <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div><hr/>
        @endforeach
        @endif
